            ...
            <div className="container container--produto">
                <div className="imagens">
                    <div className="imagens-pequenas">
                        <div className="imagem-pequena imagem-pequena--selecionada">
                            <img src="https://http2.mlstatic.com/D_NQ_NP_2X_991860-MLA84536292666_052025-F.webp"
                                alt="Imagem Pequena do Produto" />
                        </div>

                        <div className="imagem-pequena">
                            <img src="https://http2.mlstatic.com/D_NQ_NP_2X_948133-MLA84834570611_052025-F.webp"
                                alt="Imagem Pequena do Produto" />
                        </div>

                        <div className="imagem-pequena">
                            <img src="https://http2.mlstatic.com/D_NQ_NP_2X_849138-MLA84536495898_052025-F.webp"
                                alt="Imagem Pequena do Produto" />
                        </div>
                    </div>
                ...
                <div className="informacoes">
                    ...
                    <div className="produto__precos">
                        ...
                        <div className="produto__desconto">
                            <p className="produto_preco">R$ 849</p>
                            <p className="verde">R$ 26% OFF</p>
                        </div>

                        <p>Em <span className="verde">12x R$ 70,75 sem juros</span></p>
                    </div>
                ...
                <div className="pedido">
                    ...
                    <div className="pedido__quantidade">
                        ...
                        <p className="preto-55 ">(10 disponiveis)</p>
                    </div>
