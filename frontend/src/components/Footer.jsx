            ...
            <div className="container container--footer">
                <div className="diferenciais">
                    <div className="diferencial">
                        ...
                        <p>Com Mercado Pago, você paga com cartão, boleto ou Pix. Você também pode pagar em até 12x sem
                            cartão com a Linha de Crédito.</p>
                    </div>
                    ...
                    <div className="diferencial">
                        <img src="https://http2.mlstatic.com/storage/homes-korriban/assets/images/ecosystem/protected.svg"
                            ...
                            <p>Você não gostou do que comprou? Devolva! No Mercado Livre não há nada que você não possa fazer,
                                porque você está sempre protegido.</p>
                    </div>
                </div>
